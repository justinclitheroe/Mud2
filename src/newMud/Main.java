...
public class Main {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Mob c = new Mob("Cat","A wandering black cat. Possibly a source of bad luck. It sounds like the cat is mumbling about chemical bonds", world.getDaMap().get(0),1,1,1,1,1);//,world.getDaMap().get(rnGesus(0,6)),1,1);	
